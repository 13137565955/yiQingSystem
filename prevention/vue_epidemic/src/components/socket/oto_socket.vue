      ...
      <el-col :span="24" style="">
        <el-card class="group">
          <div class="group_head">
            <el-page-header class="title" @back="goBack" content="匿名聊天">
...
export default {
  ...
  sockets: {
    ...
    getmsgo(data) {
      if (data.msgData.uid == window.localStorage.getItem("id")) data.if = true;
      else data.if = false;
  ...
  methods: {
    ...
    join() {
      ...
      let joinData = {};
      joinData.name = window.localStorage.getItem("name");
      joinData.uid = window.localStorage.getItem("id");
      joinData.img = window.localStorage.getItem("img");
