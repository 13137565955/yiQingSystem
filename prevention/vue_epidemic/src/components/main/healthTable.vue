      ...
      <el-col :span="24">
        ...
        <el-card v-if="show == false">
          ...
          <el-table :data="tableData1" border style="width: 100%">
            ...
            <el-table-column prop="gohubei" label="是否去过高危地区">
            </el-table-column>
            <el-table-column prop="hubeiren" label="是否为高危地区人员">
            </el-table-column>
            <el-table-column prop="mask" label="是否接触过高危地区人员">
            </el-table-column>
            <el-table-column prop="leaveout" label="是否离开过学校">
            </el-table-column>
            <el-table-column prop="hesuan" label="是否做过核酸检测">
            </el-table-column>
            <el-table-column prop="masknum" label="口罩数量"> </el-table-column>
