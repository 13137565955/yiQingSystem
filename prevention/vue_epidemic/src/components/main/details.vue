<template>
  <div>
    <div slot="header" class="clearfix" style="text-align: center">
      <span>通知详情查看</span>
      <el-button style="float: right; padding: 3px 0" type="text" @click="cls"
        >关闭</el-button
      >
    </div>
    <el-table :data="tableData1" border style="width: 100%">
      ...
      <el-table-column prop="title" label="通知的班级"> </el-table-column>
        ...
        this.tableData1 = [
          {
            ...
            title: "头裂了",
            content: null,
            createtime: "2020-08-26T07:39:52.000Z",
            class: "1班;2班",
          },
        ];
